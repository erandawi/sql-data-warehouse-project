...
- **Integration**: Combine both sources into a sigle, user-freindly data model designed for analytical queries
...
Hi there! I'm **Eranda Wijewantha**, also known as **erandawi** | **tomcat** | **skye**. I'm an IT professional and passionate tektoker on a mission to share knowledge and make working with data enjoyable and engaging!
